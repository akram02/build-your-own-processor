...
কয়েকটা জায়গা একটু খুলে বলি। শুরুতে `main` কেন `ra` stack-এ রাখছে? কারণ `main` নিজেই হয়তো অন্য কারো ডাকা function — তার `ra`-তে main-এর ফেরার ঠিকানা আছে। এখন `jal add_func` করলে সেই `ra` চাপা পড়ে যাবে! তাই call-এর আগে পুরোনো `ra` stack-এ জমিয়ে রাখা, আর call-এর পরে আবার তুলে আনা। `addi sp, sp, -4` দিয়ে stack-এ ৪ বাইট জায়গা করা হয় (stack নিচের দিকে বাড়ে, তাই বিয়োগ), শেষে `addi sp, sp, 4` দিয়ে সেই জায়গা ফেরত দেওয়া হয় — না দিলে stack ধীরে ধীরে উপচে পড়বে (stack overflow!)। লক্ষ করো `add_func` নিজে কোনো function ডাকে না, তাই তার `ra` নিরাপদ — তার stack ছোঁয়ার দরকারই হয়নি।
