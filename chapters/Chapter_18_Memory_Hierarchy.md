...
**Spatial locality (স্থানগত স্থানীয়তা):** এইমাত্র যে address ছুঁয়েছো, তার ঠিক পাশের address গুলোও শিগগিরই লাগার সম্ভাবনা বেশি। একটা array এর উপর দিয়ে হাঁটো — `a[0]`, তারপর `a[1]`, তারপর `a[2]`... পরপর সাজানো। অথবা instruction গুলো — সাধারণত একটার পর একটা পরপর execute হয়।
