...
> অনুযায়ী আউটপুটটা কেমন হওয়া উচিত সেটা তুমি আগেই (simulation থেকে) জানো — এখন
...
32-bit সংখ্যায় (machine code) রূপান্তর করতে শিখেছিলে? সেই হেক্সাডেসিমাল
...
> দুনিয়ায় power supply-তে সামান্য ওঠানামা থাকে, তাপমাত্রা বদলায়, তার-এ সিগন্যাল
...
> simulation-এর কাছাকাছি থাকে, সেটাই দারুণ সাফল্য।
...
professional করে তোলে — আর honestly, এগুলো করতে দারুণ লাগে। এ যেন নতুন গাড়ি
