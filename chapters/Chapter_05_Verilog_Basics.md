...
প্রতিটা output লাইনের নিজস্ব শর্ত আছে: `out[2]` কেবল তখনই 1 হবে যখন `in` ঠিক 2 (`2'b10`)। যেহেতু `in` একসময় একটামাত্র মান ধরতে পারে, তাই চারটার মধ্যে একটামাত্র শর্ত মেলে — তাই আউটপুটে সবসময় ঠিক একটা bit জ্বলে (এটাকে বলে "one-hot" — গুচ্ছে একটাই 1 গরম থাকে)। আর প্রতিটা শর্তে `enable &` জুড়ে দেওয়ার মানে হলো একটা মাস্টার সুইচ: `enable` যদি 0 হয়, তাহলে `enable & (যাকিছু)` সবসময় 0, মানে গোটা decoder নিভে যায়, সব output শূন্য। এমন on/off নিয়ন্ত্রণ বড় সিস্টেমে ভীষণ দরকারি।
