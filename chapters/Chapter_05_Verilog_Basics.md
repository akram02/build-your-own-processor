...
আর `$time` দেয় simulation-এ এই মুহূর্তে কত সময় হয়েছে (সেই `#10`-এর ঘড়িটার পাঠ)। এটা দিয়েই তুমি জানো কোন ঘটনা কখন ঘটছে, আর তাই output-এ সময় ছাপাতে বারবার এটা ব্যবহার করবে। `$realtime` প্রায় একই, শুধু এটা ভগ্নাংশ সময়ও দিতে পারে (দশমিকসহ) — খুব সূক্ষ্ম timing দেখতে লাগে, যা আপাতত দরকার পড়বে না।
